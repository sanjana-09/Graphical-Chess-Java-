...
public abstract class Piece {
  ...
  /**
  * Returns Unicode string for the chess image of the Piece
  * 
  * @param  pieceSymbol  String  The character representing the Piece
  * 
  * @return  String  The method assigning Unicode characters to Pieces
  * @author  Sanjana Khot
  */
  public String toImage(String pieceSymbol){
	  return PieceCode.StringtoImage(pieceSymbol);
  }
