...
public final class PieceCode {
  ...
  /**
   *Assigns Unicode symbols to Piece characters 
   * @param pieceSymbol  String  The alphabet assigned to the Piece
   * @return  String  The Unicode string for the corresponding chess Piece
   * @author Sanjana Khot (skhot1@sheffield.ac.uk)
   */
  public static String StringtoImage(String pieceSymbol){
	  String s;
	  switch (pieceSymbol){
		case "P": 
		case "p": return "\u265f";
